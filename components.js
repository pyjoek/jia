...
<nav class="nav">
  <div class="nav__inner">
    <a href="index.html" class="nav__logo">
      <img src="logo.png" alt="Joel in Action (JIA)" style="height:80px;width:auto;display:block;" />
    </a>
    <ul class="nav__links">
  ...
  <div class="container">
    <div class="footer__grid">
      <div class="footer__brand">
        <a href="index.html" style="display:inline-block;margin-bottom:.3rem">
          <img src="logo.png" alt="Joel in Action (JIA)" style="height:90px;width:auto;filter:brightness(0) invert(1) opacity(0.85);" />
        </a>
      ...
      <div class="footer__col footer__contact">
        ...
        <a href="https://github.com/pyjoek" target="_blank" style="display:inline-flex;align-items:center;gap:.4rem;margin-top:1rem;color:var(--accent);font-size:.85rem;font-weight:600;font-family:'Share Tech Mono',monospace">
          ⌥ github.com/pyjoek ↗
        </a>
      </div>
    </div>
